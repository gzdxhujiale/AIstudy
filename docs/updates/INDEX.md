...
- 版本号：0.1.76
- 更新时间：2026-06-29 18:37:15
- 功能更新：收口知识库 DB-first 数据边界、教材批注服务、数学粘贴和打包数据守卫；新增数据边界检查、数学粘贴回归、教材回归验证和打包产物清单记录；抽出数学粘贴共享解析模块，稳定处理 ChatGPT/KaTeX/MathML/纯文本中的箭头、集合符号和上下标
...
### 0.1.76 - 2026-06-29 18:37:15

- 收口知识库 DB-first 数据边界、教材批注服务、数学粘贴和打包数据守卫
- 新增数据边界检查、数学粘贴回归、教材回归验证和打包产物清单记录
- 抽出数学粘贴共享解析模块，稳定处理 ChatGPT/KaTeX/MathML/纯文本中的箭头、集合符号和上下标
- GitHub：https://github.com/SnowLove0303/AIstudy-Public.git
- 分支：main
- 提交：b4a3329
